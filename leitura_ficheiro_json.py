...
with open("Ficheiros_Json/" + sys.argv[1], encoding=encondF) as myfile:
    data=myfile.read()
...
with open('dicionario_Ingles.txt', encoding=encondF) as f:
    gene_data = f.read()
...
freq_to_table(variaveisSoc,ocorrencias,sys.argv[1],numeroPalavras,comentario_Tabela,s,numeroPalavrasH,freqComentario)
